Medicoin Core version *0.15.1* is now available from:

  <https://download.medicoin.com.br/medicoin-0.15.1/>
...
A number of changes to the way Medicoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 plaquetas per kB (0.00001 MDI). This is to prepare for dropping the minimum transaction fee to 0.1 plaquetas per kB (0.0001 MDI) in the next release.
