...
#if defined(NDEBUG)
# error "Medicoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Medicoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s MDI additional fees, %d delta bytes\n",
