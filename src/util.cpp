...
const char * const BITCOIN_CONF_FILENAME = "medicoin.conf";
const char * const BITCOIN_PID_FILENAME = "medicoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Medicoin";
#else
    // Unix
