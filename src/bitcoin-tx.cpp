...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s medicoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  medicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded medicoin transaction") + "\n" +
              "  medicoin-tx [options] -create [commands]   " + _("Create hex-encoded medicoin transaction") + "\n" +
              "\n";
